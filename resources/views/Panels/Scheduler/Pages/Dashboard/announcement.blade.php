...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/Panel/Scheduler/Pages/Dashboard/announcement.css') }}">
    ...
    <div class="container">
        ...
        <div class="dashboard-header">
            <div class="header-left">
                <nav class="nav-links">
                    <a href="{{ route('Panels.Scheduler.Pages.Dashboard.dashboard') }}" class="nav-link">Dashboard</a>
                    <a href="{{ route('Panels.Scheduler.Pages.Dashboard.announcement') }}" class="nav-link active">Announcement</a>
                </nav>
            </div>
        ...
        <div class="main-container">
            ...
            <div class="right-section">
                <div class="scheduler-header">
                    <div class="scheduler-title">From Admin</div> 
                </div>
