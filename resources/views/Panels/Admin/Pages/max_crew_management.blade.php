...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/Panel/Admin/Pages/max_crew_management.css') }}">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                ...
                currentWeekDates.forEach((date, index) => {
                    ...
                    if (dayCard) {
                        ...
                        if (inputElement) {
                            ...
                            // Disable input if date is in the past
                            const inputDate = new Date(date);
                            inputDate.setHours(0, 0, 0, 0); // Set to start of day for comparison
                            
                            if (inputDate < today) {
                                inputElement.disabled = true;
                                inputElement.classList.add('disabled-input');
                                inputElement.title = "Cannot edit past dates";
                            } else {
            ...
            function handleInputChange(event) {
                ...
                // Don't process changes for disabled inputs
