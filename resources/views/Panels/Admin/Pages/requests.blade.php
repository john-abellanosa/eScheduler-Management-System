...
@section('page-subtitle', 'Review and manage requests from crew and managers')
    ...
    <body>
                ...
                <div class="filters-top-row">
                    <div class="filters-left"> 
                        ...
                        <div class="filter-row">
                            ...
                            <button class="filter-btn" data-type="leave">Leave</button>
                ...
                <div class="modal-header">
                    <div class="modal-header-content">
                        ...
                        <div class="modal-header-text">
                            <h3 id="modalRequestTitle">Leave Request</h3>
                            <div class="requester-info" id="modalRequesterInfo">
                                <!-- Initiator's name and role will be added here -->
                            </div>
                        </div>
                    </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const modalRequesterInfo = document.getElementById('modalRequesterInfo'); // Updated
                ...
                // Updated sample request data with sorted by status: Pending, Approved, Declined
                const requestData = [
                    // Pending requests (first 6)
                    {
                        id: 1,
                        name: "Sarah Johnson",
                        role: "Crew",
                        ...
                        type: "leave",
                        title: "Leave Request",
                        reason: "Planned family vacation to visit relatives in another state. Need time off for travel and family gatherings.",
                        leaveType: "Annual Leave",
                        fromDate: "Jan 20, 2024",
                        toDate: "Jan 25, 2024",
                    ...
                    },
                    {
                        ...
                        reason: "Prior personal commitment - have a doctor's appointment scheduled",
                        initiatorName: "Emma Wilson",
                        initiatorDepartment: "Kitchen",
                        initiatorStation: "ASM/Grill",
                        initiatorTimeIn: "09:00 AM",
                        initiatorTimeOut: "05:00 PM",
                        receiverName: "Alex Thompson",
                        receiverRole: "Crew",
                    ...
                    },
                    {
                        ...
                        initiatorName: "David Miller",
                        initiatorPosition: "Service Manager",
                        initiatorTimeIn: "08:00 AM",
                        initiatorTimeOut: "04:00 PM",
                        receiverName: "Maria Garcia",
                        receiverRole: "Manager",
                        giveDate: "Dec 24, 2024",
                    ...
                    },
                    {
                        ...
                        type: "leave",
                        title: "Leave Request",
                        reason: "Family vacation - planned trip to the beach with family",
                    ...
                    // Approved requests (next 1)
                    {
                        ...
                        type: "leave",
                        title: "Leave Request",
                        reason: "Doctor's appointment for regular checkup and medical tests",
                    ...
                    // Declined requests (last 1)
                    {
                        ...
                        initiatorName: "Lisa Anderson",
                        initiatorPosition: "Shift Leader",
                        initiatorTimeIn: "07:00 AM",
                        initiatorTimeOut: "03:00 PM",
                        partnerName: "Tom Brown",
                        partnerRole: "Manager",
                        partnerPosition: "Service Manager",
                ...
                function createTableRow(request, index) {
                    ...
                    row.dataset.role = request.role.toLowerCase();
                        ...
                        <td>
                            <div class="requester-info">
                                ...
                                <div>
                                    ...
                                    <div class="requester-role">${request.role}</div>
                                </div>
                            </div>
                        </td>
                        <td>
                ...
                function createMobileCard(request, index) {
                    ...
                    card.dataset.role = request.role.toLowerCase();
                        ...
                        <div class="mobile-card-header">
                            <div class="requester-info-mobile">
                                ...
                                <div>
                                    ...
                                    <div class="mobile-requester-role">${request.role}</div>
                                </div>
                            </div>
                ...
                function getTypeIcon(type) {
                    switch(type) {
                        case 'leave': return 'fa-umbrella-beach'; // Changed from calendar-alt to umbrella
                ...
                function openModal(requestId) {
                    ...
                    // Set initiator's name and role below the request title
                    modalRequesterInfo.innerHTML = `
                        <span>${request.name}</span>
                        <span class="requester-role-badge">${request.role}</span>
                    `;
                ...
                function generateModalContent(request) {
                    ...
                    if (request.type === 'leave') {
                        content = generateLeaveRequestContent(request);
                ...
                function generateLeaveRequestContent(request) {
                    return `
                        <div class="details-section">
                            ...
                            <div class="date-range">
                                <div class="date-range-item detail-item">
                                    <span class="detail-label">Start Date</span>
                                    <span class="detail-value">${request.fromDate}</span>
                                </div>
                                <div class="date-range-item detail-item">
                                    <span class="detail-label">End Date</span>
                                    <span class="detail-value">${request.toDate}</span>
                                </div>
                            </div>
                        </div>
                    `;
                ...
                function generateSwapRequestContent(request) {
                    const isManager = request.role === 'Manager';
                            ...
                            <div class="person-card">
                                <div class="person-header">
                                    <div class="person-info">
                                        ...
                                        <p>${request.initiatorName} (${request.role})</p>
                                    </div>
                                </div>
                                <div class="person-details">
                                    ...
                                    ${isManager ? 
                                        `<div class="detail-item">
                                            ...
                                            <span class="detail-value">${request.initiatorPosition}</span>
                                        </div>` : 
                                        `<div class="detail-item">
                            ...
                            <div class="person-card">
                                <div class="person-header">
                                    <div class="person-info">
                                        ...
                                        <p>${request.partnerName} (${request.partnerRole || 'Crew'})</p>
                                    </div>
                                </div>
                                <div class="person-details">
                                    <div class="detail-item">
                                    ...
                                    ${(request.partnerRole === 'Manager' || isManager) ? 
                                        `<div class="detail-item">
                                            <span class="detail-label">Position</span>
                                            <span class="detail-value">${request.partnerPosition}</span>
                                        </div>` : 
                                        `<div class="detail-item">
                                            <span class="detail-label">Department</span>
                    ...
                    return `
                        <div class="details-section">
                            ...
                            <div class="detail-item" style="margin-top: 16px;">
                                ...
                                <span class="detail-value">${request.receiverName} (${request.receiverRole || 'Crew'})</span>
                            </div>
                        </div>
                    `;
                }
                    ...
                    tableRows.forEach((row, index) => {
                        ...
                        if (currentSearchTerm && shouldShow) {
                            ...
                            shouldShow = (
                                ...
                                row.dataset.role.includes(searchIn) ||
