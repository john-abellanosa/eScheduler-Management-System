...
@section('title', 'Crew Shift Records')
...
<head>
    ...
    @vite(['resources/js/Panels/Admin/Pages/Shift_Records/crew.js'])
    <link rel="stylesheet" href="{{ asset('css/Panel/Admin/Pages/Shift_Records/crew.css') }}">
