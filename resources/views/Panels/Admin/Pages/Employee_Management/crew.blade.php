...
<head>
    ...
    @vite(['resources/js/Panels/Admin/Pages/Crew/crew.js']) 
    @vite(['resources/js/Panels/Admin/Pages/Crew/add_crew_modal.js'])
    <link rel="stylesheet" href="{{ asset('css/Panel/Admin/Pages/Crew/crew.css') }}">
    <link rel="stylesheet" href="{{ asset('css/Panel/Admin/Pages/Crew/modal.css') }}">
        ...
        <div id="crew-tab">
            <div class="control-panel">
                <div class="page-title">
                    <h2>Crew</h2>
                    <p>Manage crew for your restaurant</p>
                </div>
            ...
            <div class="status-filter-container"> 
                ...
                <div class="total-count" id="totalCount">
                    ...
                    <span id="countText">Total Crew</span>
                </div>
            </div>

            <!-- Desktop Crew Table -->
            <div class="employee-table" id="crewTableContainer">
                <table>
                    <thead>
                        <tr>
                            <th>Name</th>
    ...
    <div id="employeeModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-actions">
                ...
                <button type="submit" class="btn-modal-primary" id="submitBtn">Add Crew</button>
            </div>
        </div>
    </div>
