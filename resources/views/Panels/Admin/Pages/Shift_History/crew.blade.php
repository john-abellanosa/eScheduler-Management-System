    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            datePicker.addEventListener('change', function() {
                if (this.value === "") {
                    // If date is cleared or empty, show all days in week
                    showAllDaysInWeek = true;
                } else {
                    ...
                    // Ensure date is within current week (double-check)
            ...
            function calculateItemsPerPage() {
                ...
                if (window.innerWidth < 768) {
                    ...
                    // Desktop: calculate based on screen height
                    const rowHeight = 64;
                    ...
                    console.log('Calculated items per page:', calculatedItems, 'screenHeight:', screenHeight);
