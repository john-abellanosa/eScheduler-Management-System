...
<head>
    ...
    <title>Manager Shift History</title>
    <style>
        :root {
            --primary-blue: #1a3a8f;
        ...
        /* Adjust column widths - Removed Station column */
        ...
        @media (max-width: 768px) { 
            ...
            /* Control Panel - Mobile grid layout */
            .control-panel {
                display: grid;
            ...
            /* Position colors for mobile */
            .mobile-position-service-manager {
                color: #1a3a8f;
                font-weight: 600;
            }

            .mobile-position-manager-in-charge {
                color: #2a56d6;
                font-weight: 600;
            }

            .mobile-position-shift-leader {
                color: #138496;
                font-weight: 600;
            }

            .mobile-position-expediter {
                color: #218838;
                font-weight: 600;
            }
