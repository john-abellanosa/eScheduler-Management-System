...
<head>
    ...
    <title>eScheduler - Admin Panel Login</title>
        ...
        <div class="login-side">
            <div class="login-content">
                ...
                <form id="loginForm">
                    ...
                    <button type="submit" class="login-btn" id="loginBtn" onclick="window.location.href='{{ route('Panels.Scheduler.Pages.dashboard') }}'">
