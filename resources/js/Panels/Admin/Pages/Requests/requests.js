document.addEventListener("DOMContentLoaded", function () {
    ...
    const requests = [
        ...
        },
        {
            ...
            giveTo: "Alex Thompson",
            shiftDate: "Jan 25, 2024",
    ...
    function createListCard(req) {
        ...
        // Create dynamic content based on request type
        let dynamicContent = '';
        ...
        // Common meta items for all types
        const commonMeta = ` 
                    <span class="meta-item">
                    ...
                    <div class="list-actions">
                        ...
                        <!--
                        <button class="list-btn view" onclick="window.requestManager.viewRequestDetails(${
                            req.id
                        })" title="View Details">
        ...
        if (req.type === 'leave') {
            dynamicContent = `
                ...
                <div class="card-meta">
                    ...
                    <div><i class="far fa-calendar"></i> Leave Date: ${req.leaveDate}</div>
            ...
            dynamicContent = `
                <p class="card-reason"><strong>Reason:</strong> ${req.reason}</p>
                <div class="card-meta">
                    <div><i class="fas fa-user-friends"></i> Swap Partner: ${req.swapPartner}</div>
        ...
        <div class="request-card-grid" data-id="${req.id}" data-status="${req.status}" data-type="${req.type}">
            ...
            <div class="card-actions-container">
                <div class="card-actions">
                    ...
                    <!--
                    <button class="card-btn view" onclick="window.requestManager.viewRequestDetails(${
                        req.id
                    })" title="View Details">
                        <i class="fas fa-eye"></i>
                    </button>
    ...
    function filterRequests() {
        filteredRequests = requests.filter((req) => {
            ...
            const searchMatch =
                ...
                (req.leaveType && req.leaveType.toLowerCase().includes(filters.search)) ||
                (req.swapPartner && req.swapPartner.toLowerCase().includes(filters.search)) ||
                (req.giveTo && req.giveTo.toLowerCase().includes(filters.search));
    ...
    function viewRequestDetails(id) {
        ...
        if (req) {
            ...
            if (req.type === 'leave') {
                details += `Leave Type: ${req.leaveType}\nLeave Date: ${req.leaveDate}\n`;
            } else if (req.type === 'swap') {
                details += `Swap Partner: ${req.swapPartner}\nSwap Date: ${req.swapDate}\n`;
            } else if (req.type === 'give') {
                details += `Give To: ${req.giveTo}\nShift Date: ${req.shiftDate}\n`;
            }
            
            details += `Date Requested: ${req.dateRequested}\nSubmitted: ${req.submitted}`;
